...
export default function Download() {
  return <main id="main-content" className="document">
    ...
    <h2>Included in the Mac build</h2>
    ...
    <ul className="release-list"><li><Circle size={15} />Live capture, privacy, and recovery qualification</li><li><Circle size={15} />Independent Mac installation and update checks</li><li><Circle size={15} />Final license notices, terms, and model packaging</li><li><Circle size={15} />Published, verified installer and release metadata</li></ul>
    ...
    <p className="fine">Release status reviewed September 7, 2026. App screenshots use synthetic work data.</p>
  </main>;
}
