...
/// Onboarding mirror of the Hippocampus "Inspect Key Wrap" panel.
/// TrustSlide presents this as a sheet so the user can verify the
/// trust claim before granting permissions. Content-free — never
/// renders key bytes or any brain data.
