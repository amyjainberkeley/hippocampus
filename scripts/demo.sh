...
do_screenshot() {
    ...
    bold "Screenshot 1/2: Hippocampus menu-bar (click the menu-bar icon area)"
    ...
    bold "Screenshot 2/2: Recall UI window (click the Recall UI window)"
    ...
    ls -lh "$SHOT_DIR"/*.png 2>/dev/null || true
