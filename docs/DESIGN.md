...
- **G2 — Invisible overhead.** Steady-state ≤10–15% of one CPU core, ≤2 GB RAM at default settings; modest battery/thermal impact. Users on perf-constrained hardware may opt into a Performance tier (~1–2% / ~250 MB) at reduced functionality via OnboardingTier per brain-v2 §5.7. The user should not notice it running. (Footprint SLO amended 2026-05-31 per ratified G2 — see `docs/research/orchestrator-ratification-state-2026-05-31.md` §2.)
