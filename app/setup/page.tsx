...
export default function Setup() {
  return <main className="document">
    ...
    <section className="step"><h2>2. Choose what it can remember.</h2><p>Follow the app's setup screens. Screen Recording lets Hippocampus capture visible work; Accessibility supports its privacy checks. Grant each permission in System Settings, then return to the app.</p><p>Keep sensitive apps excluded. Browser-specific setup and optional imports are separate choices. You do not need to grant Full Disk Access for basic screen memory.</p></section>
