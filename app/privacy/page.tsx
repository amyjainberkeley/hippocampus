...
export default function Privacy() {
  return <main className="document">
    ...
    <h1>Your memory belongs to you.</h1>
    ...
    <h2>Deletion has limits.</h2><p>Removing the app alone does not remove its memory folder. Use the app's deletion controls for stored memories. Copies in exports, backups, or other tools are separate; deletion is not a forensic-erasure guarantee.</p>
    <h2>About this website.</h2><p>This site contains no memory-upload form, advertising tracker, or newsletter signup. Its hosting provider still processes web requests and may keep operational logs. Public installers, when available, will be linked from the project's release host. App update checks also make network requests.</p>
